...
const { UserSignUp, UserSignIn, validate, updateUserDetails } = require('../controllers/user');
...
router.post('/add-income', isLoggedIn, addIncome)
    ...
    .put('/update-user-details', isLoggedIn , updateUserDetails);
    // .put('/update-user-details', validate , updateUserDetails);
